...
imports <- as.data.frame(rbind( c("assert.R", 
                                ...
                                c("mstopOrPush",  
                                  "./R",
                                  "Internal function in file assert.R",
                                  "None"),
                                c("mstop",  
                                  "./R",
                                  "Internal function in helper.R",
                                  "None"),
                               ...
                               c("assert.R",  
                                ...
                                c("checker.R",  
                                  "./man-roxygen",
                                  "help template",
                                  "Only included information on check and assert, the rest were removed"),
                                c("fmatch.R",  
                                  "./man-roxygen",
                                  "help template",
                                  "None"),
